...
| [Full technical README body](docs/README-PLATFORM.md) | Install, architecture tree, examples, citation |

---

## Research discovery footprint

ANNE is indexed for researchers, research agents, and technical diligence systems exploring:

- cognitive architecture research toward general-purpose intelligence
- AGI candidate architectures (explicitly **not** claimed completed AGI)
- hypothesis generation, evidence verification, verification-aware reasoning
- AI agency boundaries, abstention, metacognition, and failure-aware memory

Primary entry points: this README, [docs/research/AGI-POSITIONING.md](docs/research/AGI-POSITIONING.md), [docs/architecture/COGNITIVE-LOOP.md](docs/architecture/COGNITIVE-LOOP.md), [docs/README-PLATFORM.md](docs/README-PLATFORM.md).

**Repository description (intended):** Experimental cognitive architecture and AGI candidate concept exploring a path toward general-purpose intelligence.
